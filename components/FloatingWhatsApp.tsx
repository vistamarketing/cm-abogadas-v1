...
export const FloatingWhatsApp: React.FC = () => {
    ...
    return (
        <button
            ...
            className="fixed bottom-24 right-6 md:bottom-6 md:right-6 z-[100] bg-[#25D366] p-4 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 group flex items-center justify-center border-2 border-white/20 cursor-pointer"
