...
// node_modules/tinacms/dist/react.js
...
function useTina(props) {
  ...
  const id = import_react.default.useMemo(
    () => hashFromQuery(stringifiedQuery),
    [stringifiedQuery]
  );
  const processedData = import_react.default.useMemo(() => {
    if (props.data) {
      const dataCopy = JSON.parse(JSON.stringify(props.data));
      return addMetadata(id, dataCopy, []);
    }
  }, [props.data, id]);
  const [data, setData] = import_react.default.useState(processedData);
  const [isClient, setIsClient] = import_react.default.useState(false);
  const [quickEditEnabled, setQuickEditEnabled] = import_react.default.useState(false);
  const [isInTinaIframe, setIsInTinaIframe] = import_react.default.useState(false);
...
function useEditState() {
  const [edit, setEdit] = import_react.default.useState(false);
  import_react.default.useEffect(() => {
...
//# sourceMappingURL=tinacms_dist_react.js.map
