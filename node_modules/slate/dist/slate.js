(function (global, factory) {
      ...
      case 'insert_node':
        {
          ...
          var descendants = Node.isText(node) ? [] : Array.from(Node.nodes(node), function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
              p = _ref2[1];
  ...
  function positions(editor) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    return /*#__PURE__*/regenerator.mark(function _callee() {
      var _options$at, at, _options$unit, unit, _options$reverse, reverse, _options$voids, voids, range, _Range$edges, _Range$edges2, start, end, first, isNewBlock, blockText, distance, leafTextRemaining, leafTextOffset, skippedPaths, _iterator, _step, _loop, _ret, calcDistance;
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 4:
            ...
            _loop = /*#__PURE__*/regenerator.mark(function _loop() {
              var _marked, _step$value, node, path, hasSkippedAncestor, maybeYield, nextPath, e, s, isFirst;
              return regenerator.wrap(function _loop$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    return _context2.delegateYield(maybeYield(Editor.end(editor, Path.previous(path))), "t0", 10);
                  case 10:
                  ...
                  case 13:
                    ...
                    return _context2.delegateYield(maybeYield(Editor.start(editor, nextPath)), "t1", 16);
                  case 16:
                    return _context2.abrupt("return", 0);
                  case 17:
                    ...
                    return _context2.delegateYield(maybeYield(Editor.start(editor, path)), "t2", 19);
                  case 19:
                    return _context2.abrupt("return", 0);
                  case 20:
                  ...
                  case 23:
                    ...
                    return _context2.delegateYield(maybeYield({
                      path: path,
    ...
    Editor.withoutNormalizing(editor, function () {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (!voids && Node.isElement(_node2) && (Editor.isVoid(editor, _node2) || Editor.isElementReadOnly(editor, _node2)) || !Path.isCommon(_path2, start.path) && !Path.isCommon(_path2, end.path)) {
            matches.push(entry);
            lastPath = _path2;
          }
        }
    ...
    Editor.withoutNormalizing(editor, function () {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (starting && Node.isElement(node) && !editor.isInline(node) && !Path.isAncestor(_path, firstLeafPath)) {
            starting = false;
          }
      ...
      Transforms.splitNodes(editor, {
        at: at,
        match: function match(n) {
          return splitBlock ? Node.isElement(n) && Editor.isBlock(editor, n) : Node.isText(n) || Editor.isInline(editor, n);
        },
  ...
  var liftNodes = function liftNodes(editor) {
    ...
    Editor.withoutNormalizing(editor, function () {
      ...
      if (match == null) {
        match = Location.isPath(at) ? matchPath(editor, at) : function (n) {
          return Node.isElement(n) && Editor.isBlock(editor, n);
        };
      }
