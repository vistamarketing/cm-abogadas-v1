...
function hasMessages(object) {
  return Object.keys(object).some((key) => {
    if (_6BYUUR4Mcjs.isObject.call(void 0, object[key])) {
...
function set(values, path, value) {
  ...
  const key = k;
  const isIntegerKey = _6BYUUR4Mcjs.isInteger.call(void 0, key);
  const nextValues = isIntegerKey ? values || [] : values || {};
  const nestedValues = nextValues[key];
  const result = rest.length && (Array.isArray(nestedValues) || _6BYUUR4Mcjs.isObject.call(void 0, nestedValues)) ? set(nestedValues, rest, value) : value;
  if (isIntegerKey) {
  ...
  for (const key of keys) {
    ...
    if (Array.isArray(currentValue)) {
      result[key] = currentValue.map((v) => {
        if (_6BYUUR4Mcjs.isObject.call(void 0, v)) {
          return setAll(v, value);
        }
        return value;
      });
    } else if (_6BYUUR4Mcjs.isObject.call(void 0, currentValue)) {
...
function createFormStore(props = {}) {
  ...
  const errors = _6BYUUR4Mcjs.defaultValue.call(void 0, 
    props.errors,
    syncState == null ? void 0 : syncState.errors,
    props.defaultErrors,
    {}
  );
  const touched = _6BYUUR4Mcjs.defaultValue.call(void 0, 
    props.touched,
  ...
  const initialState = {
    ...
    errors,
    touched,
    validating: _6BYUUR4Mcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.validating, false),
    submitting: _6BYUUR4Mcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitting, false),
    submitSucceed: _6BYUUR4Mcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitSucceed, 0),
    submitFailed: _6BYUUR4Mcjs.defaultValue.call(void 0, syncState == null ? void 0 : syncState.submitFailed, 0),
    valid: !hasMessages(errors)
  };
  const form = _WPBYRKFQcjs.createStore.call(void 0, initialState, collection, props.store);
  ...
  const callbacks = _WPBYRKFQcjs.createStore.call(void 0, callbacksInitialState, syncCallbacks);
  _WPBYRKFQcjs.setup.call(void 0, form, () => _WPBYRKFQcjs.init.call(void 0, callbacks));
  _WPBYRKFQcjs.setup.call(void 0, 
    form,
    () => _WPBYRKFQcjs.sync.call(void 0, form, ["validating", "errors"], (state) => {
  ...
  return {
    ...
    setError: (name, error) => form.setState("errors", (errors2) => {
      ...
      const nextError = _6BYUUR4Mcjs.applyState.call(void 0, error, prevError);
