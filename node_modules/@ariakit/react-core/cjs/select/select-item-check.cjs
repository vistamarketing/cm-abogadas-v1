...
var TagName = "span";
var useSelectItemCheck = _743QABRAcjs.createHook.call(void 0, 
  function useSelectItemCheck2({ store, checked, ...props }) {
    const context = _react.useContext.call(void 0, _4NZHMZNFcjs.SelectItemCheckedContext);
    checked = checked != null ? checked : context;
    props = _QHTB3O7Vcjs.useCheckboxCheck.call(void 0, { ...props, checked });
    return props;
  }
);
var SelectItemCheck = _743QABRAcjs.forwardRef.call(void 0, function SelectItemCheck2(props) {
...
exports.SelectItemCheck = SelectItemCheck; exports.useSelectItemCheck = useSelectItemCheck;
