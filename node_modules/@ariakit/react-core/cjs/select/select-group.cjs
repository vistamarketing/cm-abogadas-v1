...
var TagName = "div";
var useSelectGroup = _743QABRAcjs.createHook.call(void 0, 
  function useSelectGroup2(props) {
    props = _5GHA7P5Fcjs.useCompositeGroup.call(void 0, props);
    return props;
  }
);
var SelectGroup = _743QABRAcjs.forwardRef.call(void 0, function SelectGroup2(props) {
...
exports.SelectGroup = SelectGroup; exports.useSelectGroup = useSelectGroup;
