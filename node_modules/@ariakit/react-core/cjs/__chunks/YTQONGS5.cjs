...
var useComposite = _743QABRAcjs.createHook.call(void 0, 
  function useComposite2({
    ...
    const context = _WI7QXQL7cjs.useCompositeProviderContext.call(void 0, );
    store = store || context;
    ...
    const [, setBaseElement] = _KGFTRA3Ccjs.useTransactionState.call(void 0, 
    ...
    _react.useEffect.call(void 0, () => {
      ...
      const itemElement = (_a = _MIBORXQWcjs.getEnabledItem.call(void 0, store, activeId2)) == null ? void 0 : _a.element;
    ...
    _KGFTRA3Ccjs.useSafeLayoutEffect.call(void 0, () => {
      ...
      const activeElement = (_a = _MIBORXQWcjs.getEnabledItem.call(void 0, store, activeId)) == null ? void 0 : _a.element;
    ...
    const onBlurCapture = _KGFTRA3Ccjs.useEvent.call(void 0, (event) => {
      ...
      if (!virtualFocus2) return;
      const activeElement = (_a = _MIBORXQWcjs.getEnabledItem.call(void 0, store, activeId2)) == null ? void 0 : _a.element;
    ...
    props = _KGFTRA3Ccjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _WI7QXQL7cjs.CompositeContextProvider, { value: store, children: element }),
      [store]
    );
    const activeDescendant = store.useState((state) => {
      ...
      return (_a = _MIBORXQWcjs.getEnabledItem.call(void 0, store, state.activeId)) == null ? void 0 : _a.id;
    });
    props = {
      "aria-activedescendant": activeDescendant,
      ...props,
      ref: _KGFTRA3Ccjs.useMergeRefs.call(void 0, ref, setBaseElement, props.ref),
      onKeyDownCapture,
      onKeyUpCapture,
      onFocusCapture,
      onFocus,
    ...
    props = _4JH5Q6AQcjs.useFocusable.call(void 0, { focusable, ...props });
    return props;
  }
);
var Composite = _743QABRAcjs.forwardRef.call(void 0, function Composite2(props) {
