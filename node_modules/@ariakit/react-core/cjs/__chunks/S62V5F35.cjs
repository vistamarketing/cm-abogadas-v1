...
function useCollectionRenderer({
  ...
  store = store || context;
  const items = _YY2UXBEBcjs.useStoreState.call(void 0, 
    store,
  ...
  const baseId = _KGFTRA3Ccjs.useId.call(void 0, props.id);
  const horizontal = orientation === "horizontal";
  const elements = _react.useMemo.call(void 0, () => /* @__PURE__ */ new Map(), []);
  const [elementsUpdated, updateElements] = _KGFTRA3Ccjs.useForceUpdate.call(void 0, );
  ...
  const processVisibleIndicesEvent = _KGFTRA3Ccjs.useEvent.call(void 0, processVisibleIndices);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnScrollProp = _KGFTRA3Ccjs.useBooleanEvent.call(void 0, renderOnScroll);
  _react.useEffect.call(void 0, () => {
  ...
  const renderOnResizeProp = _KGFTRA3Ccjs.useBooleanEvent.call(void 0, renderOnResize);
  _react.useEffect.call(void 0, () => {
...
var CollectionRenderer = _743QABRAcjs.forwardRef.call(void 0, function CollectionRenderer2(props) {
