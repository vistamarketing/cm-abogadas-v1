...
var useDisclosureContent = _743QABRAcjs.createHook.call(void 0, function useDisclosureContent2({ store, alwaysVisible, ...props }) {
  ...
  const otherElement = _YY2UXBEBcjs.useStoreState.call(void 0, store.disclosure, "contentElement");
  ...
  props = _KGFTRA3Ccjs.useWrapElement.call(void 0, 
    props,
    (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _5BVSKVUNcjs.DialogScopedContextProvider, { value: store, children: element }),
    [store]
  );
  ...
  props = {
    ...
    hidden,
    ...props,
    ref: _KGFTRA3Ccjs.useMergeRefs.call(void 0, id ? store.setContentElement : null, ref, props.ref),
    style
  };
  return _misc.removeUndefinedValues.call(void 0, props);
});
var DisclosureContentImpl = _743QABRAcjs.forwardRef.call(void 0, function DisclosureContentImpl2(props) {
  const htmlProps = useDisclosureContent(props);
  return _743QABRAcjs.createElement.call(void 0, TagName, htmlProps);
});
var DisclosureContent = _743QABRAcjs.forwardRef.call(void 0, function DisclosureContent2({
  unmountOnHide,
  ...props
}) {
  const context = _HHXD2YNZcjs.useDisclosureProviderContext.call(void 0, );
