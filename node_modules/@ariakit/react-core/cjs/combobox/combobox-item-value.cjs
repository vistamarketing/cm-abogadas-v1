...
var useComboboxItemValue = _743QABRAcjs.createHook.call(void 0, function useComboboxItemValue2({ store, value, userValue, ...props }) {
  const context = _MLRWKUIEcjs.useComboboxScopedContext.call(void 0, );
  store = store || context;
  const itemContext = _react.useContext.call(void 0, _MLRWKUIEcjs.ComboboxItemValueContext);
  const itemValue = value != null ? value : itemContext;
  const inputValue = _YY2UXBEBcjs.useStoreState.call(void 0, store, (state) => userValue != null ? userValue : state == null ? void 0 : state.value);
...
var ComboboxItemValue = _743QABRAcjs.forwardRef.call(void 0, function ComboboxItemValue2(props) {
